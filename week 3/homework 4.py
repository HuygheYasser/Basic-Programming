# Write the function check_emailaddress that checks for a valid student email address 
# (firstname.lastname@student.howest.be). 
# What kinds of checks are possible? 
...
addre = 'bung.holiogma@il.com'


juist = re.match(emailpattern, addre)

if juist == None:
    print("not correct email formatting")
else:
    print("gg")
